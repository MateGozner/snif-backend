        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCheckup = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    VetContact = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewMatchNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    MessageNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    BreedingRequestNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    PlaydateRequestNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationStartTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    NotificationEndTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BreederVerifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BreederVerifications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Pets_MedicalHistory_MedicalHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BreederVerifications_UserId",
                table: "BreederVerifications",
                column: "UserId",
                unique: true);
